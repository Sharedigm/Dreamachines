...
<div class="content">
	<p><%= application.name %> includes a collection of apps for communicating with your contacts and managing your data. </p>
	...
	<div class="section">
		<div class="row">
			...
			<div class="col-sm-8">
				...
				<% if (!app.disabled && !app.hidden && app.platform != 'mobile') { %>
